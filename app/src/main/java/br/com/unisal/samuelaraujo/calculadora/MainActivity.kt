...
class MainActivity : ComponentActivity() {
    ...
    /**
     * Categorias visuais de botao: agrupam os botoes por funcao (numero, operador,
     * igualdade, limpar) para deixar clara a intencao de cada um no codigo, mesmo
     * quando a diferenca visual entre eles e sutil.
     */
    @Composable
    fun criaBotaoPequeno(texto:String, identificador: BotaoOperacao) {
        Button(
            ...
            // O botao de igualdade recebe uma cor de destaque diferente dos
            // demais (papel semantico "error" do tema), para se diferenciar
            // visualmente dos botoes numericos e operadores comuns.
